...
if(isset($_POST['editar'])){
    ...
    $sql_edita = "UPDATE clientes SET nome = '$nome', apelido = '$apelido', posicao = '$posicao', pe_dominante = '$pe_dominante', data_nascimento = '$data_nascimento', clube = '$clube', categoria = '$categoria', telefone01 = '$telefone01', telefone02 = '$telefone02', emal = '$email', diagnostico = '$diagnostico', classificacao_id = '$classificacao_id' WHERE id = '$idCliente'";
