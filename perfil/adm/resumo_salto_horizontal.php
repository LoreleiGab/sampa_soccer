...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="box box-default">
            <?php
            $sql_wells = "SELECT * FROM testes WHERE cliente_id = '$idCliente' AND teste_tipo_id = '$teste_tipo_id' ORDER BY data";
            ...
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    while($wel = mysqli_fetch_array($query_wells)){
                        ...
                        echo "</tr>";
                        $horizontal_charts .= "{y: '".dataBR($wel['data'])."', a: ".$wel['medida']."}, ";
                    }
                    $horizontal_charts = substr($horizontal_charts,0,-2);
                    echo "</tbody>";
                    ?>
                </table>
            </div>
    ...
    <div class="col-md-6">
        <div class="box box-default">
            ...
            <div class="box-body chart-responsive">
                <div class="chart" id="horizontal-chart" style="height: 300px;"></div>
            </div>
        </div>
    </div>
    <!-- ./PESO CHART -->
